...
/**
 * Select component built with Radix UI Select primitive
 * Supports keyboard navigation, custom styling, and accessibility
 */
...
// Higher-level wrapper component for common use cases
...
// Grouped select with sections
export interface GroupedSelectProps extends Omit<SimpleSelectProps, "options"> {
  /**
